function checkPower(hasPower: boolean): void {
  if (!hasPower) {
    throw new Error('No power, unable to cook!');
  }
}
  
function addWater(water: string | null): void {
  if (water === null) {
    throw new Error('Please specify the amount of water!');
  } 
}
  
function checkItemAndTimer(itemToCook: string | null, timer: number): void {
  if (itemToCook === null) {
...
function startCooking(itemToCook: string | null, water: string | null, timer: number): void {
  if (timer <= 0) {
